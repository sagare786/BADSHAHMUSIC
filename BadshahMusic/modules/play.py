# BadshahMusic (Telegram bot project)
...
from BadshahMusic.config import ARQ_API_KEY
from BadshahMusic.config import BOT_NAME as bn
from BadshahMusic.config import DURATION_LIMIT
from BadshahMusic.config import UPDATES_CHANNEL as updateschannel
from BadshahMusic.config import que
from BadshahMusic.function.admins import admins as a
from BadshahMusic.helpers.admins import get_administrators
from BadshahMusic.helpers.channelmusic import get_chat_id
from BadshahMusic.helpers.decorators import authorized_users_only
from BadshahMusic.helpers.filters import command, other_filters
from BadshahMusic.helpers.gets import get_file_name
from BadshahMusic.services.callsmusic import callsmusic
from BadshahMusic.services.callsmusic import client as USER
from BadshahMusic.services.converter.converter import convert
from BadshahMusic.services.downloaders import youtube
from BadshahMusic.services.queues import queues
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        thumb_name = "https://telegra.ph/file/eb0e1096f248bc622a733.jpg"
...
async def jiosaavn(client: Client, message_: Message):
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your group due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @BadshahMusic to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
    ...
    keyboard = InlineKeyboardMarkup(
        [
            ...
            [
                InlineKeyboardButton(
                    text="Join Updates Channel", url=f"https://t.me/{MUSICGROUP111}"
                )
            ],
            [InlineKeyboardButton(text="❌ Close", callback_data="cls")],
        ]
